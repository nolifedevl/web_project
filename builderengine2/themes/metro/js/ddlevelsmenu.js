...
arrowpointers:{
	downarrow: [theme_path + "img/arrow-down.png", 11,7], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: [theme_path + "img/arrow-right.png", 12,12], //[path_to_right_arrow, arrowwidth, arrowheight]
