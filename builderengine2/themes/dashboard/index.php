    ...
    <div class="container-fluid">
        <div id="login">
            <div class="login-wrapper" data-active="log">
               <a class="brand" href="dashboard.html"><img src="<?=get_theme_path()?>/images/builderengine_logo.png" alt="BuilderEngine Admin"></a>
                <div id="log">
                    <div id="avatar">
                        <img src="<?=get_theme_path()?>/images/avatars/no_avatar.jpg" style="width: 78px; height: 78px;" alt="SuggeElson">
                    </div>
