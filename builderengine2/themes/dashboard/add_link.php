                                ...
                                <div class="widget-content">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <input class="span12" id="groups" type="text" name="groups" value="Guests <? foreach ($groups as $group): ?>,<?=$group->name?><?endforeach;?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <select name="parent">
                                                    ...
                                                    <option value="<?=$db_link->id?>"><?=$db_link->name?></option>
                                                    <? endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
