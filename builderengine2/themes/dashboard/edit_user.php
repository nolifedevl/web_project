            ...
            ignore: 'input[type="hidden"]',
             rules: {
                ...
                email: {
                    required: true,
                    remote: {
                        url: "/index.php/admin/user/validate_email/" + encodeURIComponent("<?=$user_data->email?>"),
                        type: "post"
                    }
                },
                username: {
                                    ...
                                    <form id="validate" class="form-horizontal" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <input type="text" id="unique_username" autocomplete="off" name="username" class="span12" disabled value="<?=$user_data->username?>" >
                                            </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <input type="text" name="name" class="span12" autocomplete="off" value="<?=$user_data->name?>" >
                                            </div>
                                        </div><!-- End .control-group  -->
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                ...
                                                <? if(file_exists("files/avatars/".$user_data->username.".jpg")): ?>
                                                    <img src="/files/avatars/<?=$user_data->username?>.jpg" alt="SuggeElson">
                                                <? else: ?>
                                                    <img src="<?=get_theme_path()?>/images/avatars/no_avatar.jpg" alt="SuggeElson">
                                                <? endif; ?>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <input type="text" id="unique_email" name="email" autocomplete="off" class="required email span12" value="<?=$user_data->email?>">
                                            </div>
                                        </div><!-- End .control-group  -->
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <input class="span12" id="groups" type="text" name="groups" value="<?=$user_data->groups_string?>" />
                                            </div>
                                        </div>
