...
<html lang="en">
  <head>
    ...
    <script src="<?=get_theme_path()?>/js/jquery.min.js"></script>
    <script src="<?=get_theme_path()?>/js/jquery-ui.min.js"></script>
    ...
    <script src="<?=get_theme_path()?>/js/plugins/forms/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script> 
    ...
    <script src="<?=get_theme_path()?>/js/plugins/forms/validation/jquery.validate.js"></script>
    <script src="<?=get_theme_path()?>/js/plugins/forms/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script> 
    <link href="<?=get_theme_path()?>/js/plugins/forms/bootstrap-wysihtml5/bootstrap-wysihtml5.css" rel="stylesheet" />
