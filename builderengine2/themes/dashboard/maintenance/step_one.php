...
{
    $("#status-message").html("Creating Administrator Accout...");


    $.get("http://" + document.domain + '/index.php/admin/install/create_admin/' + encodeURIComponent($("#admin_username").val()) + "/" + encodeURIComponent($("#admin_password").val()) + "/" + encodeURIComponent($("#admin_email").val()), function (data) {
...
function configure_website()
{
    ...
    $.get("http://" + document.domain + '/index.php/admin/install/configure/' + encodeURIComponent($("#sitename").val()) + "/" + encodeURIComponent($("#db_host").val()) + "/" + encodeURIComponent($("#db_user").val()) + "/" + encodeURIComponent($("#db_pass").val()) + "/" + encodeURIComponent($("#db_name").val()), function (data) {
        if(data == "success")
...
function install_db()
{
    ...
    $.get("http://" + document.domain + '/index.php/admin/install/install_db/' + encodeURIComponent($("#db_host").val()) + "/" + encodeURIComponent($("#db_user").val()) + "/" + encodeURIComponent($("#db_pass").val()) + "/" + encodeURIComponent($("#db_name").val()), function (data) {
        if(data == "success"){
            progress(40);
    ...
    ;
                ...
                <div class="container-fluid">
                    <div id="heading" class="page-header">
                        <h1><i class="icon20 i-dashboard"></i>Radian Installation</h1>
                    </div>
                                        ...
                                        <div class="step" id="first">
                                            ...
                                            <div class="control-group">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>  
                                                        <tr>
                                                            <td><div class="btn rounded btn-success icon16 <?if($requirements['php_version']):?> btn-success i-checkmark-3<?else:?>btn-danger i-close<?endif?>"></div><?if($requirements['php_version']):?> PHP <?=get_php_version();?><?else:?>At least version 5.0 required<?endif?></td>
