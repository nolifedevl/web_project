...
<link href="<?=get_theme_path()?>css/builderengine-theme/jquery.ui.widget.css" rel="stylesheet" /> 
<link href="<?=get_theme_path()?>js/plugins/ui/range-slider/rangeslider.css" rel="stylesheet" /> 
    <script src="<?=get_theme_path()?>js/plugins/ui/range-slider/rangeslider-ruler.js"></script>
    <script src="<?=get_theme_path()?>js/plugins/ui/animated-progress-bar/jquery.progressbar.js"></script>
 <script src="<?=get_theme_path()?>js/pages/ui-elements.js"></script><!-- Init plugins only for page -->        
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                            <div class="widget">
                                ...
                                <div class="widget-content">
                                    <div class="weather">
                                        <div class="center"><div class="location"><i class="icon16 i-location"></i> <?=$weather['location']?></div></div>
                                        <div class="center clearfix">
                                             <div class="pull-left">
                                                <div class="icon"><i class="icon64 <?=$weather['now']['icon_class']?>"></i></div>
                                                <span class="today">currently</span>
                                            </div>
                                            <div class="pull-right"><span class="degree blue"><?=$weather['now']['temp']?>&deg;</span></div>
                                        </div>
                                        <ul class="clearfix">
                                        <? for($i = 1; $i < 7; $i++): ?>
                                            <li>
                                                <span class="day"><?=date("D", $weather[$i]['time'])?></span>
                                                <span class="dayicon"><i class="icon24 <?=$weather[$i]['icon_class']?>"></i></span>
                                                <span class="max"><?=$weather[$i]['temp']['max']?>&deg;</span>
                                                <span class="min"><?=$weather[$i]['temp']['min']?>&deg;</span>
                                            </li>
                                            <?endfor;?>
                                            <!--<li>
        ...
        <div class="widget"> 
            ...
            <div class="widget-content noPadding"> 
                <ul class="recent-activity"> 
                    ...
                    <li class="item"> 
                        <span class="icon gray"><i class="icon16 <?=$entry['icon']?>"></i></span> 
                        <div class="text">
                            <?=$entry['code']?>
                            <?if($entry['url'] != ""):?>
                        ...
                        <span class="ago"><?=$entry['time']?></span> 
                    </li> 
                    <?endforeach;?>
